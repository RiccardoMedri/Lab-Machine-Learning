...
class NetRunner():
    ...
    def train(self, trainloader : torch.utils.data.DataLoader, preview : bool = False) -> None:
    ...
    def test(self, testloader : torch.utils.data.DataLoader, preview : bool = False):
        ...
        print(f'Accuratezza totale: {100 * correct // total} %')
